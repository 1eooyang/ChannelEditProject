...
public class DragRecycleAdapter extends RecyclerView.Adapter<DragRecycleAdapter.DragHolder>{
    ...
    public DragRecycleAdapter(List<String> Datas, Context context){
        this.mDatas = Datas;
    ...
    public void onBindViewHolder(DragHolder holder, int position) {
        ...
        if (position == 0) {
            holder.mTextItem.setEnabled(false);
    ...
    public void notifyDelShow(boolean isShow){
        this.isShow = isShow;
